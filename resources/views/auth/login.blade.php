...
<div class='login'>
    ...
    {{ csrf_field() }}
                ...
                @if ($errors->has('email'))
                                ...
                                @endif
                <input id='pw' name='password' placeholder='Mot de passe' type='password'/>
                <div class='remember'>
                  <input checked='' id='remember' name='remember' type='checkbox' {{ old('remember') ? 'checked' : '' }}/>
                  <label for='remember'></label>Se souvenir de moi
                </div>
